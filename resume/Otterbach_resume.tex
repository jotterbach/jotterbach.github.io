...
{\bf Member of Technical Staff (Fellow)} \hfill06/2018 - present \\
{\it OpenAI, San Francisco, CA}
\begin{itemize}
  \item Basic research of algorithms for safe Artificial General Intelligence.
\end{itemize}
...
\begin{itemize}
  ...
  \item Experience with mathematical and statistical Python libraries such as pandas, scikit-learn, NumPy and SciPy, TensorFlow, Keras, Owl, and software such as MATLAB and {\sc Mathematica}.
