...
Let's try to break this down a little bit more. In one dimension the unit "ball" and the unit "cube" are in fact identical: It's just the real line from $$-1$$ to $$1$$. This starts to change in two dimensions: The "volume" of the two-dimensional cube is given by the area of a square, which in this case is $$A_\square=4$$. Correspondingly the volume of the 2D unit ball is just the area of a circle $$A_\circ=\pi$$. The ratio between these two areas is $$A_\circ/A_\square \approx 0.785$$, which we can interpret that about $$21.5\%$$ of the volume of the unit square lie outside the unit circle. Doing the same calculation in three dimensions we find $$V_\circ / V_\square \approx 0.524$$ or already about $$46.4\%$$ of the volume are already outside of the unit ball!
...
$$
\begin{align}
\frac{ V_{\circ, d} }{ V_{\square, d}} = &  \frac{\pi^{d/2}}{2^d \Gamma(1+d/2)} \\
...
##t-SNE: Viusalization of high dimensional data
...
![Central Limit Theorem with Bernoulli experiment](/resources/tsne/central_limit_experiment.png){: .text.img-left width="60%"}
