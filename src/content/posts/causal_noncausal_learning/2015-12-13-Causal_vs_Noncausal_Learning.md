...
![Multivalued input-output relation](./imgs/NonCausalRelation_Data.png)
...
![Training and test losses of the MDN](./imgs/TrainTestLossMDN.png)
...
![Architecture of MDN output layer](./imgs/MDN_architecture.svg)
