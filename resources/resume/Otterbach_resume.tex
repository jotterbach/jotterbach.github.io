...
{\bf Full-Stack Quantum Engineer} (Software) \hfill04/2017 - present \\
{\it Rigetti Computing, Berkeley, CA}
\begin{itemize}
  \item Building quantum control software for custom hardware.
  \item Developing and implementing automated data analysis tools.
\end{itemize}
...
\begin{enumerate}
 ...
 \item Q. Wang, J. Otterbach, S. F. Yelin, \textit{Interacting in-plane molecular dipoles in a zig-zag chain}, arxiv:1607.01851 (accepted to Phys. Rev. A)
\end{enumerate}
